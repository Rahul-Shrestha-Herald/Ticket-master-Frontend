...
import TMPoints from "./pages/user/tmpoints/TMPoints";
...
// Scroll to top only on route CHANGE (not on state updates / button clicks)
const ScrollToTop = () => {
    ...
    <main className="w-full flex flex-col bg-neutral-50 min-h-screen">
      ...
      <Routes>
        ...
        <Route element={<UserProtectedRoute />}>
          ...
          <Route path="/tm-points" element={<TMPoints />} />
        </Route>
