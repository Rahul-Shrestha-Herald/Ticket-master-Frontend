...
import { FiUser, FiHome, FiEdit, FiLogOut, FiKey, FiTrash2, FiPhone, FiCalendar, FiMapPin, FiEye, FiEyeOff, FiAlertTriangle, FiCamera } from 'react-icons/fi';
...
const OperatorProfile = () => {
    ...
    const handleProfilePictureChange = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post(`${backendUrl}/api/operator/profile-picture`, formData, {
                    ...
                    <div className="flex flex-col md:flex-row md:items-center">
                        <div className="flex items-center mb-4 md:mb-0">
                            <div className="relative mr-4">
                                {operatorData?.profilePicture ? (
                                    <img
                                        src={operatorData.profilePicture}
                                        alt="Profile"
                                ...
                                <button
                                    ...
                                    className="absolute bottom-0 right-0 w-6 h-6 bg-red-600 rounded-full flex items-center justify-center text-white shadow hover:bg-red-700 transition-colors disabled:opacity-60"
