...
const OperatorLiveTracking = () => {
    ...
    useEffect(() => {
        // Use the backend URL from context and replace /api with empty string to get base URL
        const baseUrl = backendUrl ? backendUrl.replace('/api', '') : 'http://localhost:4000';
        const trackingServerUrl = `${baseUrl}/location`;
        console.log('Operator connecting to tracking server at:', trackingServerUrl);
