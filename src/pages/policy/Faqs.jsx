    ...
    const faqData = {
        general: [
            ...
            },
            {
                ...
                answer: 'You can contact our customer support team via phone at +977 1234567890, email at support@ticketmaster.com, or through the live chat feature on our website. Our support team is available 24/7 for urgent matters.'
            },
            {
            ...
            <RootLayout className="space-y-10 w-full">
                ...
                <div className="w-full bg-primary/5 rounded-xl p-8 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        ...
                        <a href="mailto:support@ticketmaster.com" className="px-6 py-3 bg-white text-primary border border-primary font-medium rounded-lg hover:bg-gray-50 transition duration-300">
                            Email Us
                        </a>
                    </div>
                </div>
