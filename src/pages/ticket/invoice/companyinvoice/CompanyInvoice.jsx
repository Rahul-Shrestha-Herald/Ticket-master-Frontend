...
const CompanyInvoice = ({ data }) => {
    ...
    return (
        <div className='w-full sm:border-t md:border-t-0 md:border-l md:col-span-1 border-dashed border-neutral-400 relative pt-4 md:pt-0 mt-4 md:mt-0'>
            ...
            <div className="hidden md:flex w-full bg-primary absolute bottom-0 right-0 rounded-br-3xl items-center justify-center px-5 py-1.5 gap-x-3">
                {data?.driverContactNumber && (
                    <div className="flex items-center gap-x-2">
                        <FaPhone className='w-3 h-3 text-neutral-100' />
                        <p className="text-xs text-neutral-100 font-light">
                            Driver: {data.driverContactNumber}
                        </p>
                    </div>
                )}
                <div className="flex items-center gap-x-2">
            ...
            <div className="md:hidden w-full bg-primary flex items-center justify-center px-3 py-1 rounded-b-xl mt-4 gap-x-3">
                {data?.driverContactNumber && (
